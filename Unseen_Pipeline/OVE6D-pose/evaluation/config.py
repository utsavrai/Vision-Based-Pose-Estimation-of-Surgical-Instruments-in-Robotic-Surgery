...
RENDER_WIDTH = 960       # the width of rendered images
...
MODEL_SCALING = 1.0 # TLESS object model scale from millimeter to meter
...
DATA_PATH = '/home/utsav/IProject/OVE6D-pose/Dataspace'
