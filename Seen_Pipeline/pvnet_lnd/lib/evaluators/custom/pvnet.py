...
class Evaluator:
    ...
    def evaluate(self, output, batch):
        ...
        # Save pose_pred as a txt file named after img_id
        pose_pred_txt_path = os.path.join('/vol/bitbucket/ur23/clean-pvnet/data/predictions', f'{img_id}.txt')
        np.savetxt(pose_pred_txt_path, pose_pred, fmt='%.8f')
