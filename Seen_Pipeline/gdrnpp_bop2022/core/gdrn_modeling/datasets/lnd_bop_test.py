...
class LND_BOP_TEST_Dataset(object):
    """lnd bop test splits."""
    ...
    def __init__(self, data_cfg):
        ...
        self.dataset_root = data_cfg.get("dataset_root", osp.join(DATASETS_ROOT, "BOP_DATASETS/lnd/test"))
...
SPLITS_LND = dict(
    lnd_bop_test=dict(
        name="lnd_bop_test",
        dataset_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lnd/test"),
        models_root=osp.join(DATASETS_ROOT, "BOP_DATASETS/lnd/models"),
        objs=ref.lnd_full.objects,
        ann_file=osp.join(DATASETS_ROOT, "BOP_DATASETS/lnd/test_targets_bop19.json"),
...
# single obj splits for lnd bop test
...
def register_with_name_cfg(name, data_cfg=None):
    ...
    if name in SPLITS_LND:
        ...
        used_cfg = data_cfg
    DatasetCatalog.register(name, LND_BOP_TEST_Dataset(used_cfg))
