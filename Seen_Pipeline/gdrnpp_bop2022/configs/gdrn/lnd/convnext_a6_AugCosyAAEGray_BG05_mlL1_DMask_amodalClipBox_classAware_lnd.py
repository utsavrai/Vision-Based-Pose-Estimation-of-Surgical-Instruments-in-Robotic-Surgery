...
OUTPUT_DIR = "output/gdrn/lnd/convnext_a6_AugCosyAAEGray_BG05_mlL1_DMask_amodalClipBox_classAware_lnd"
INPUT = dict(
    MIN_SIZE_TRAIN=540,
    MAX_SIZE_TRAIN=960,
    MIN_SIZE_TEST=540,
...
DATASETS = dict(
    TRAIN=("lnd_bop_train",),
    TEST=("lnd_bop_test",),
    DET_FILES_TEST=("datasets/BOP_DATASETS/lnd/test/test_bboxes/lnd_test.json",),
)
