...
int main (int argc, char** argv) {
  ...
  if (argc==2 && !strcmp(argv[1],"demo")) {
    ...
    // process("img/1145_left.pgm",  "img/1145_right.pgm");
    // process("img/1245_left.pgm",  "img/1245_right.pgm");
    // process("img/l1245.pgm",  "img/r1245.pgm");
    process("img/rectified_left_image.pgm",  "img/rectified_right_image.pgm");
    cout << "... done!" << endl;
