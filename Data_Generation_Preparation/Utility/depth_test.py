...
def compute_disparity(imgL, imgR):
    ...
    cv2.imwrite("depth_map.png", depth_mm)
...
def save_point_cloud(points, colors, filename):
    ...
    mask = (points[:,:,2] > points[:,:,2].min()) & np.isfinite(points[:,:,2])
...
if __name__ == "__main__":
    imgL = cv2.imread('/home/utsav/IProject/data/lnd1/filtered_left_rect_images/828.png')
    imgR = cv2.imread('/home/utsav/IProject/data/lnd1/rect_right/828.png')
