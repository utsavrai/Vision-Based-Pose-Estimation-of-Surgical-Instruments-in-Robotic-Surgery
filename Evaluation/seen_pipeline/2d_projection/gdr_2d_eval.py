...
def main(ground_truth_dir, csv_file_path, ply_file_path, K):
    ...
    for gt_file in sorted(os.listdir(ground_truth_dir)):
        ...
        # Convert 3x4 pred_pose to 4x4 by adding [0 0 0 1] at the bottom
        pred_pose = np.vstack([pred_pose, [0, 0, 0, 1]])
...
projection_metrics = main(ground_truth_dir, csv_file_path, ply_file_path, K)
